...
import com.chillapps.musicelsius.Configuration.SpotifyConfiguration;
import com.chillapps.musicelsius.Entity.UserDetails;
import com.chillapps.musicelsius.Entity.UserDetailsRepository;
import com.chillapps.musicelsius.Service.UserProfileService;
...
public class SpotifyController {
	...
	public String getSpotifyUserCode(@RequestParam("code") String userCode, HttpServletResponse response)	throws IOException {
		...
		System.out.println("Our Code: " + userCode);
		SpotifyApi object = spotifyConfiguration.getSpotifyObject();
		...
		try {
			...
			return "Access Token: " + authorizationCode.getAccessToken() + "<br>" +
	        "Refresh Token: " + authorizationCode.getRefreshToken() + "<br>" +
	        "Expires in: " + authorizationCode.getExpiresIn();
		} catch (Exception e) {
